...
export const resumeData: ResumeData = {
  ...
  introductionDetails: [
    {
      title: "사용자 편의를 설계하는 개발자",
      detail: [
        {
          detail:
            "안녕하세요. 사용자가 서비스를 사용하는 과정에서 어디서 혼란을 느끼고 어떤 흐름에서 불편함이 발생하는지 고민하는 프론트엔드 개발자 박상아입니다.<br />저는 <b>3년간 커머스 플랫폼 퍼블리셔</b>로 근무하며 다양한 쇼핑몰 구축과 운영 업무를 경험하며, 단순히 화면을 구현하는 것을 넘어 <b>사용자가 더 자연스럽게 서비스를 사용할 수 있는 흐름</b>을 만드는 것에 관심을 가지게 되었습니다. 특히 플랫폼 제약으로 인해 사용자 경험 측면에서 아쉬움이 있어도 구조적으로 해결하기 어려운 상황을 반복해서 경험하게 되면서, <b>사용자 문제를 직접 설계와 로직 단위에서 해결할 수 있는 개발자</b>가 되고 싶다고 생각했습니다.",
        },
        {
