  ...
  introductionDetails: [
    {
      ...
      detail: [
        {
          detail:
            "안녕하세요. 사용자 흐름 속 불편함을 구조적으로 해결하는 과정에 가장 큰 흥미를 느끼는 프론트엔드 개발자 박상아입니다.<br />3년간 다양한 쇼핑몰 구축 업무를 경험하며, 단순히 화면을 구현하는 것을 넘어 <b>사용자가 더 자연스럽게 서비스를 사용할 수 있는 흐름</b>을 만드는 것에 관심을 가지게 되었습니다. 특히 플랫폼 제약으로 인해 사용자 경험 측면에서 아쉬움이 있어도 구조적으로 해결하기 어려운 상황을 반복해서 경험하게 되면서, <b>사용자 문제를 직접 설계와 로직 단위에서 해결할 수 있는 개발자</b>가 되고 싶다고 생각했습니다.",
        },
        {
