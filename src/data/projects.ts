export const projects: Project[] = [
  {
    ...
    description: [
      ...
      "<b>FE 팀장, Git 총괄, 디자인 리드 역할</b>을 맡아 화면 설계부터 구현, 협업 흐름까지 폭넓게 주도했습니다. 기능을 단순히 구현하는 데 그치지 않고, <b>사용자가 입력 과정에서 느끼는 피로를 줄이고 필요한 정보에 더 빠르게 도달할 수 있는 UX</b>를 만드는 데 집중했습니다.",
  ...
  },
  {
    ...
    description: [
      ...
      "<b>React와 @shopby/react-components를 활용해 쇼핑몰 전반의 사용자 화면을 구현</b>하고, <b>PC와 모바일 환경을 모두 고려한 UI 개발</b>을 담당했습니다. 단순한 퍼블리싱을 넘어, 실제 사용 흐름 속에서 불편함이 생기지 않도록 화면 구조와 상호작용을 세심하게 다듬는 데 집중했습니다.",
    ...
    troubleshooting: [
      ...
      },
      {
        ...
        problem:
          "<b>헤더의 미니카트에 표시되는 수량과 실제 장바구니 페이지의 수량이 일치하지 않는 문제</b>가 있었습니다. 장바구니 수량이 변경되었음에도 헤더 영역이 즉시 갱신되지 않아, 사용자가 보는 화면에 따라 다른 수량이 표시되는 상황이었습니다. 이는 <b>주문 직전 단계에서 혼란을 유발하고 서비스 신뢰도를 떨어뜨릴 수 있는 문제</b>라고 판단했습니다.",
        solution:
          "<b>장바구니 수량 변경 이후 헤더 미니카트 영역이 다시 렌더링되도록 상태 갱신 흐름을 점검하고 수정</b>했습니다. 이를 통해 장바구니 페이지에서 수량이 변경되었을 때 헤더에도 최신 수량이 반영되도록 개선했고, 사용자가 <b>어느 화면에서든 일관된 장바구니 상태를 확인</b>할 수 있도록 안정성을 높였습니다.",
        keywords: ["React", "리렌더링", "상태 동기화", "UX 안정성"],
      },
    ],
  },
  {
    ...
    description: [
      ...
      "<b>HTML, CSS, JavaScript, jQuery, Handlebars.js 기반의 Shopby SDK 환경</b>에서 전체 페이지의 구조와 스타일을 구성하고, 다양한 운영 요구사항을 실제 화면에 반영했습니다. <b>PC와 모바일을 모두 고려한 퍼블리싱</b>과 함께, 브랜드 톤을 해치지 않으면서도 사용성이 자연스럽게 유지되도록 디테일을 다듬는 데 집중했습니다.",
